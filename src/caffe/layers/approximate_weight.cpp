...
void reduce_singular_value(float *s, int n) {
...
void approoximate_matrix(float* A, int nrows, int ncols, float* U,
	float* S, float* V, float* dummy)
{
...
int approximate_weight(float *a, int n) {
	...
	float *dummy = (float *)malloc(n * n * sizeof(float));;
	...
	Singular_Value_Decomposition(a, n, n, u, s, v, dummy);
	reduce_singular_value(s, n);
	approoximate_matrix(a, n, n, u, s, v, dummy);
