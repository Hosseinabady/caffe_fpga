...
#ifdef USE_FPGA
template <typename Dtype>
void MultinomialLogisticLossLayer<Dtype>::Forward_fpga(
	const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
	std::cout << "void MultinomialLogisticLossLayer<Dtype>::Forward_fpga should be implemented by Mohammad" << std::endl;
